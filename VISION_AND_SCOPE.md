# Vision & Scope Document: Task Manager с аналитикой и интеграциями

**Дата:** 2025-06-30
**Версия:** 0.1v
**Автор:** [MindlessMuse666]
...
- Используется Python/Django для бэкенда, JavaScript/TypeScript для фронтенда и база данных PostgreSQL.
- Разработка ведется одним разработчиком (вами).
